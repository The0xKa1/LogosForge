...
- 前端：Next.js + TypeScript 单页工作台，包含教材上传、索引状态、知识图谱画布、整合决策、RAG 问答、教师对话和报告预览入口。
...
- 后端 Python 编译检查通过：`python3 -m compileall backend/app backend/scripts`
...
4. 若要继续增强，优先处理 `docs/TODO.md` 中 P0/P1 项。
